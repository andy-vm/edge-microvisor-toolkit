...
%package system-i386
Summary: QEMU system emulator for i386
Requires: %{name}-system-x86-core = %{version}-%{release}
%{requires_all_modules}
%description system-i386
This package provides the QEMU system emulator for i386.
...
* Thu Feb 27 2025 Lishan Liu <lishan.liu@intel.com> - 8.2.0-16
- Enable pulseaudio to qemu audio driver

* Mon Feb 03 2025 Swee Yee Fonn <swee.yee.fonn@intel.com> - 8.2.0-15
- Add additional QEMU SRIOV patches.

* Thu Jan 16 2025 Andy Peng <andy.peng@intel.com> - 8.2.0-14
- Separate qemu ui related packages to pkg qemu-with-ui

* Tue Dec 24 2024 Anuj Mittal <anuj.mittal@intel.com> - 8.2.0-13
- Fix CVE-2023-6683, CVE-2023-6693 and CVE-2024-3567

* Thu Nov 14 2024 Leow Chun Fung <chun.fung.leow@intel.com> - 8.2.0-12
- Repackage qemu-system-i386.

* Mon Aug 26 2024 Rachel Menge <rachelmenge@microsoft.com> - 8.2.0-11
- Update to build dep latest glibc-static version

* Fri Oct 04 2024 Anuj Mittal <anuj.mittal@intel.com> - 8.2.0-10
- Use qemu-ipxe for PXE ROM instead of ipxe.
