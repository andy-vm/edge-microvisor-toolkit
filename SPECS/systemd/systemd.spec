...
Source26:       99-default-suid-dumpable.conf

Source27:       99-magic-sysrq.conf
...
Patch0002: add-pidfs-magic.patch

# Filesystem found in kernel header but not in filesystems-gperf.gperf: PID_FS_MAGIC"
Patch0003: add-bcachefs-magic.patch
...
install -Dm0644 -t %{buildroot}%{_pkgdocdir}/ %{SOURCE28}
...
* Fri Feb 28 2025 Anuj Mittal <anuj.mittal@intel.com> - 255-26
- Backport patches to fix build with kernel-headers 6.12

* Wed Jan 15 2025 Anuj Mittal <anuj.mittal@intel.com> - 255-25
- Revert some hardening settings

* Tue Jan 1 2025 Zhang, Baoli <baoli.zhang@intel.com> - 255-24
- Harden the sysctl runtime parameters (#15832)

* Mon Dec 30 2024 Anuj Mittal <anuj.mittal@intel.com> - 255-23
- Revert changes to harden sysctl params

* Tue Dec 24 2024 Naveen Saini <naveen.kumar.saini@intel.com> - 255-22
- Correct changelog entry.

* Fri Dec 23 2024 Zhang, Baoli <baoli.zhang@intel.com> - 255-21
- Harden the sysctl runtime parameters (#15832)

* Thu Dec 12 2024 Daniel McIlvaney <damcilva@microsoft.com> - 255-20
- Version bump to force signing with new Azure Linux secure boot key

* Fri Nov 29 2024 Wang, Junyuan <junyuan.wang@intel.com> - 255-19
- Set default value of fs.suid_dumpable to 0 to disable the ability
  for any setuid program to write a core file.
